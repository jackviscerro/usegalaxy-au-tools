...
python scripts/write_report_from_log.py -j $BUILD_NUMBER  -o $REPORT_FILE
...
# hub pull-request -m "New and updated tools $REPORT_DATE" # REMEMBER THAT YOU WANT THIS LINE UNCOMMENTED IRL
